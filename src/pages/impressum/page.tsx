      ...
      <main className="max-w-4xl mx-auto px-6 py-16">
        <div className="bg-white rounded-2xl shadow-lg p-8 lg:p-12">
          ...
          <div className="prose prose-lg max-w-none text-neutral-800">
            ...
            <div className="mb-8">
              <p className="mb-2"><strong>MY AESTHETIC Berlin</strong></p>
              <p className="mb-2">Berlin</p>
            ...
            <div className="mb-8">
              <p className="mb-2">
                Instagram: <span className="font-semibold">@my_aestheticss_berlin</span>
              </p>
              <p className="mb-2 text-sm opacity-80">
                Terminanfragen und Fragen ausschließlich per Direktnachricht über Instagram.
              </p>
            </div>

            <h3 className="text-xl font-semibold mb-3 mt-6">Öffnungszeiten</h3>
            <div className="mb-8">
              <p className="mb-2">Termine nach Vereinbarung.</p>
              <p className="mb-2 text-sm opacity-70">
                Genaue Zeiten werden im Rahmen der Terminzusage individuell abgestimmt.
              </p>
            </div>
            ...
            <div className="mt-12 pt-8 border-t-2 border-neutral-200">
              <p className="text-sm opacity-70 text-neutral-700">
                Stand: Januar 2025
              </p>
            </div>
          </div>
